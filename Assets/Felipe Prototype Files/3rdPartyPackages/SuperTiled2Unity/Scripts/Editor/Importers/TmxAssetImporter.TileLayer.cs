...
namespace SuperTiled2Unity.Editor
{
    public partial class TmxAssetImporter
    {
        ...
        {
            PreProcessTileWithCustomLayersData(goTilemap.name, cx, cy, out var properties);
            ...
            {
                PlaceTileAsTile(goTilemap, tilemap, tilemapRenderer, tile, tileId, pos3, properties);
            }
        }
        ...
        private void PlaceTileAsTile(GameObject goTilemap, Tilemap tilemap, TilemapRenderer tilemapRenderer, 
            SuperTile tile, TileIdMath tileId, Vector3Int pos3, CurrentTileCustomProperties properties)
        {
